package com.mylovin.rmq.config;

import com.mylovin.rmq.util.MQConsumeMsgListenerProcessor;
import com.mylovin.rmq.util.RocketMQErrorEnum;
import com.mylovin.rmq.util.RocketMQException;
...
public class MQConsumerConfiguration {
    ...
    public DefaultMQPushConsumer getRocketMQConsumer() throws RocketMQException {
        ...
        try {
            ...
            consumer.start();
            LOGGER.info("消费者启动成功!!! groupName:{},topics:{},namesrvAddr:{}", groupName, topics, namesrvAddr);
